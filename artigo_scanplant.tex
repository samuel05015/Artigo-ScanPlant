...
O Diagrama de Casos de Uso Geral (Figura 5) apresenta uma visão de alto nível dos serviços oferecidos pelo ScanPlant. Em consonância com Sommerville (2011), os casos de uso representam objetivos observáveis dos atores e evitam expor decisões internas de implementação. O visitante consulta a galeria pública, cria uma conta, autentica-se e recupera o acesso; o cultivador identifica plantas, organiza a coleção e os cuidados, consulta o assistente botânico, participa da comunidade e gerencia seu perfil; e o administrador gerencia usuários, modera conteúdo e audita operações. APIs externas, filtros de segurança e rotinas de enriquecimento de dados não aparecem como casos de uso nesta visão geral, pois constituem mecanismos internos detalhados nos diagramas de arquitetura e de sequência.

\begin{figure}[H]
\centering
\includegraphics[width=0.96\textwidth]{figuras/figura5_caso_de_uso.png}
